...
function draw_pie(day, gt, rooms){
    ...
    color_pie = d3.scaleOrdinal(d3.schemeCategory20)
        .domain(["Staff", "VIP", "Newsman", "Ordinary People", "Specialist", "Exhibitor"]);
}
    ...
    function change_pie (day, t, rooms){
        ...
        d3.json('data/room_minute_count.json', function (error, data) {
            ...
            var name_list = ["VIP", "Newsman", "Staff", "Specialist", "Exhibitor", "Ordinary People"];
        ...
        for (let i = 0; i < rdata.length; i++) {
            ...
            svgPie.append("text").attr("class", "legend").attr("x", 80).attr("y", -50 + 20*i).text(rdata[i].label).style("font-size", "12px").attr("alignment-baseline","middle")
        }
